...
public class KernelTargetTest extends ExecutableTargetTest {
    ...
    @Option(name = "min-kernel-version",
            description =
                    "The minimum kernel version needed to run a test.  The test name should be the key and the minimum kernel version should be the value.  Should contain at least the kernel version and major revision, and optionally the minor revision, separated by periods, e.g. 5.4 or 4.19.1")
    ...
    public Integer getDeviceKernelVersion() throws DeviceNotAvailableException {
        ...
        if (result.getStatus() != CommandStatus.SUCCESS) {
            throw new DeviceRuntimeException("Failed to get the kernel version with uname",
    ...
    public void runBinary(String binaryPath, ITestInvocationListener listener,
            TestDescription description) throws DeviceNotAvailableException, IOException {
